...
const expertise = [
  ...
  },
  {
    ...
    description: "Shifting to a growth-oriented perspective",
  },
  {
    icon: Users,
    title: "Leadership Training",
    description: "Enhancing team performance and effectiveness",
  },
  {
    icon: Heart,
    title: "Holistic Well-being",
    description: "Integrating psychology with self-care strategies",
  },
];
...
export default function Services() {
  return (
    <Layout>
      <title>
        Services | Y.A.S.H. - Holistic Personal Development & Corporate
        Training
      </title>
      <meta
        name="description"
                ...
                <div className="max-w-4xl mx-auto">
                  ...
                  <Button variant={isDark ? "hero" : "gold"} size="lg" asChild>
                    <a
                      ...
                      target={
                        service.landingUrl !== "#" ? "_blank" : undefined
                      }
                      rel={
                        service.landingUrl !== "#"
                          ? "noopener noreferrer"
            ...
            {[
              {
                ...
                description:
                  "We understand your unique challenges, goals, and aspirations",
              },
              {
                step: "02",
                title: "Customized Plan",
                description:
                  "We design a personalized program tailored to your needs",
              },
              {
                step: "03",
                title: "Deep Work",
                description:
                  "Engage in transformative sessions with expert guidance",
              },
              {
                step: "04",
                title: "Lasting Change",
                description:
                  "Integrate learnings for sustainable growth and success",
              },
            ].map((item, index) => (
