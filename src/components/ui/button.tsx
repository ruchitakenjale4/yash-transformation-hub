...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "rounded-lg bg-primary text-primary-foreground hover:bg-primary/90 shadow-sm hover:shadow-md",
        ...
        gold: "rounded-2xl bg-gold-gradient text-[hsl(233,51%,10%)] font-bold tracking-wider shadow-gold hover:shadow-[0_8px_40px_hsl(42_60%_58%/0.5)] hover:scale-[1.02] active:scale-[0.98] relative overflow-hidden before:absolute before:inset-0 before:bg-[linear-gradient(110deg,transparent_25%,hsl(0_0%_100%/0.2)_37%,transparent_63%)] before:bg-[length:200%_100%] hover:before:animate-[shimmer_1.5s_ease-in-out]",
        hero: "rounded-2xl bg-gold-gradient text-[hsl(233,51%,10%)] font-bold tracking-wider shadow-gold hover:shadow-[0_8px_40px_hsl(42_60%_58%/0.5)] hover:scale-[1.02] active:scale-[0.98] relative overflow-hidden before:absolute before:inset-0 before:bg-[linear-gradient(110deg,transparent_25%,hsl(0_0%_100%/0.2)_37%,transparent_63%)] before:bg-[length:200%_100%] hover:before:animate-[shimmer_1.5s_ease-in-out]",
